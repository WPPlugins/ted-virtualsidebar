...
See the page of VirtualSideBar : http://wp.tedac.fr/en/plugins/ted_virtualsidebar/

See also: http://wp.tedac.fr/en/plugins/

== Installation ==

   * Upload the Ted2-VirtualSidebar plugin to your blog
   * Activate it
   ...
   * Select the templates pages for each sidebar ( Index.php, Single.php, Archive.php, Page.php & Category.php )
   ...
   Of course now you need to adjust the style.css
